...
static volatile uint8_t mode1 = 0;  // 0=RPM  1=Load  2=IAT
static volatile uint8_t mode2 = 0;  // reserved for later
static volatile uint8_t mode3 = 0;  // 0=Coolant+Batt 1=Voltage 2=Raw
